...
<main class="max-w-screen-xl mx-auto px-8 md:px-16 py-20">
  <h1 class="text-4xl font-bold mb-4" style="color: var(--brand-primary); font-family:'Abhaya Libre',serif;">Property Management</h1>
  <p class="text-gray-600 text-lg leading-relaxed max-w-2xl" style="font-family:'Abhaya Libre',serif;">
    We provide comprehensive property management services to landlords and investors, ensuring your assets are well-maintained, compliant, and generating consistent returns.
  </p>
</main>
