...
<main class="max-w-screen-xl mx-auto px-8 md:px-16 py-20">
  <h1 class="text-4xl font-bold mb-4" style="color: var(--brand-primary); font-family:'Abhaya Libre',serif;">Property Compliance</h1>
  <p class="text-gray-600 text-lg leading-relaxed max-w-2xl" style="font-family:'Abhaya Libre',serif;">
    We ensure your properties meet all legal and safety regulations — from gas and electrical certificates to fire safety assessments and HMO licensing.
  </p>
</main>
